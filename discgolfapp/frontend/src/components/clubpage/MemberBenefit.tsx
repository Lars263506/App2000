...
const MemberBenefit = () => {
  ...
  return (
    <div className="flex justify-center w-full">
      <div className="w-full max-w-4xl py-4 bg-[#E7EFFB] rounded-xl">
        <h1 className="mb-4 text-2xl font-bold">{t('member_benefit_title')}</h1>

        <h2>{t('member_benefit_intro')}</h2>

        <ul className="mt-4 pl-5 list-disc space-y-2 text-left">
          <li>
